# ![dsf](https://github.com/PUTvision/qgis-deep-segmentation-framework/blob/devel/plugin/deep_segmentation_framework/icon.png?raw=true) QGIS: Deep Segmentation Framework
