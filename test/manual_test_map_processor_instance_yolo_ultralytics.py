...
MODEL_FILE_PATH = os.path.join(EXAMPLE_DATA_DIR, 'earthquake_segmentor_yolo_v8_21_09_23.onnx')
RASTER_FILE_PATH = os.path.join(EXAMPLE_DATA_DIR, 'tile_img_1_9_png.rf.058cef38273ca9aa63e86ea761841315.jpg')
